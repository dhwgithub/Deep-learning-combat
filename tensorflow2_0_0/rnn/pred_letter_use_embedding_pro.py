...
checkpoint_save_path = "../save_model/pred_letter_use_embedding_pro_model/pred_letter_use_embedding_pro.ckpt"
...
file = open('../save_model/pred_letter_use_embedding_pro_weights.txt', 'w')  # 参数提取
