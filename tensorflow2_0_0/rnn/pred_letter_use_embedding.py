...
checkpoint_save_path = "../save_model/pred_letter_use_embedding_model/pred_letter_use_embedding.ckpt"
...
file = open('../save_model/pred_letter_use_embedding_weights.txt', 'w')  # 参数提取
